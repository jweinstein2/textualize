...
function Onboarding() {
  ...
  function analyze() {
    ...
    axios
      ...
      .catch(() =>
        showError("Invalid data source", "Select another backup and try again"),
      );
  }
      ...
      <div className="body">
        ...
        >
          ...
          <Stepper.Step icon={<IconMailOpened />}>
            Create an unencrypted iPhone backup This is required to parse
            message data on your Mac.
          ...
          <Stepper.Step icon={<IconShieldCheck />}>
            We understand your data is important and private. That&apos;s why
